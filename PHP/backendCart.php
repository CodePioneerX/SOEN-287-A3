...
if(isset($_POST['ed']))
{
    ...
    <body>
        ...
        <button type='button'  style='float:right ; margin-right:5%;margin-top:3%;' style=' padding:10px;padding-bottom:1mm; padding-left:1mm; ;padding-right:1mm;padding-top:0mm;margin-top:80px; margin-bottom: 30px;'onclick='up()' >
